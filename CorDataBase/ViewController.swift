...
class ViewController: UIViewController {
    ...
    private func insertUser() {
        ...
        let studentEntity = NSEntityDescription.entity(forEntityName: "STUDANT", in: viewContext)!
    ...
    private func getStudents() {
        ...
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>.init(entityName: "STUDANT")
    ...
    @IBAction func saveButtonClicked(_ sender: UIButton) {
        ...
        if nameTextField.text?.count == 0 || addressTextField.text?.count == 0 {
